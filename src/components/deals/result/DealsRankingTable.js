                            ...
                            footer={
                                <div>
                                    <div className="footer">
                                        <Typography.Text onClick={() => this.handleChange('numberOfTradeRanks')} style={{marginRight: 12}} className={this.state.rankType === 'numberOfTradeRanks' ? 'selected' : ''}>거래량</Typography.Text>
                                        <Typography.Text onClick={() => this.handleChange('numberOfNewHighPriceRanks')} style={{marginRight: 12}} className={this.state.rankType === 'numberOfNewHighPriceRanks' ? 'selected' : ''}>신고가</Typography.Text>
                                        <Typography.Text onClick={() => this.handleChange('unitPriceRanks')} className={this.state.rankType === 'unitPriceRanks' ? 'selected' : ''}>평당가</Typography.Text>
                                    </div>
                                    <Table dataSource={this.filter(searchStore.rankResult)}
                                           size="small"
                                           pagination={false}>
                                        <Table.Column
                                            align="center"
